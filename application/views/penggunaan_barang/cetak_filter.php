...
<body onLoad="window.print()">
    ...
    <div style="text-align: center; ">
        <font size="3"><b><u>LAPORAN PENGGUNAAN BARANG CABANG <?php echo strtoupper($nama_cabang);?><br> <?php echo strtoupper(tgl_indo($tgl1));?> SAMPAI DENGAN <?php echo strtoupper(tgl_indo($tgl2));?></u></b></font><br>
    </div>
    <br>
   ...
   <tr>
                                                 ...
                                                 <tbody>
                                             <?php $no=1; $to1=0; foreach ($data_penggunaan_barang->result_array() as $i) :
                                            $id_penggunaan_barang=$i['id_penggunaan_barang'];
                                            $to1=$to1+$i['jumlah_penggunaan'];
                                          ?>
            ...
            <?php endforeach ?>
               <!--  <tr>
                                              ...
                                              <td colspan="4" style="text-align:center;">TOTAL PENGGUNAAN</td>
                                              <td colspan="1"><?php// echo $to1;?></td> 
                                              <td colspan="1"></td> 
