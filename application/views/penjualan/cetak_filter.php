...
<body onLoad="window.print()">
    ...
    <div style="text-align: center; ">
        <font size="3"><b><u>LAPORAN PENJUALAN CABANG <?php echo strtoupper($nama_cabang);?><br> <?php echo strtoupper(tgl_indo($tgl1));?> SAMPAI DENGAN <?php echo strtoupper(tgl_indo($tgl2));?></u></b></font><br>
    </div>
    <br>
 ...
 <tr>
                                          ...
                                          <tbody>
                                             <?php $no=1; $to1=0; foreach ($data_penjualan->result_array() as $i) :
            ...
            <tr>
                                              ...
                                              <td colspan="9" style="text-align:center;"> TOTAL KESELURUHAN</td>
