...
<body onLoad="window.print()">
    ...
    <div style="text-align: center; ">
        <font size="3"><b><u>LAPORAN DATA LABA RUGI TAHUN CABANG <?php echo strtoupper($nama_cabang);?> <?php echo $tahun;?> BULAN <?php echo strtoupper($bulan);?></u></b></font><br>
    </div>
    <br>
<br>
  <!--   <div style="text-align: center;">
...
<hr>
 ...
 <?php $summmp=0;
 foreach ($this->db->query("SELECT *,SUM(biaya_pengeluaran) as hasil FROM pengeluaran where YEAR(tanggal_pengeluaran) = '$tahun' AND MONTH(tanggal_pengeluaran) = '$bln' AND pengeluaran.id_cabang='$id_cabang'  GROUP by nama_pengeluaran")->result_array() as $i) :
...
<?php endif;?>
   ...
   <tr style="vertical-align: top; text-align: left;">
      ...
      <td > <?php echo rupiah($summmp+$qwjelk+$jum_penggajian);?></td> 
 </tr>
  </tbody>
</div>
</table>
...
<table border="0"  style="margin-left: 80px; font-size: 11pt;font-family: 'Times New Roman';  "  class="table " >
  ...
  <tbody>
 <tr style="vertical-align: top; text-align: left;">
      <td width="300px">Laba Rugi </td>
      <td width="150px">-</td>
      <td> <?php echo rupiah($laba-($summmp+$qwjelk+$jum_penggajian));?> (<?php if(($laba-($summmp+$qwjelk+$jum_penggajian))>=0):?>Laba<?php else:?>Rugi<?php endif;?>)</td> 
 </tr>
