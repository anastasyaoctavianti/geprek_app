                ...
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div>
                                      <h4 class="card-title" style="float: left; margin-left: 20px; margin-top: 20px;">TAMBAH COMPLEMENT KARYAWAN</h4>
                                </div>
                                <div class="card-content">
                            <form  action="<?php echo base_url().'complement_karyawan/simpan_complement_karyawan'?>" method="post" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-xl-6 col-md-6 col-12 mb-1">
                                            <div class="form-group">
                                                ...
                                                <input required value="<?php echo date('Y-m-d');?>" name="tanggal_ambil" type="date" class="form-control" >
                                            </div>
                                        </div>
                                        ...
                                        <hr>
                                         ...
                                         <div class="col-xl-3 col-md-6 col-12 mb-1">
                                            <div class="form-group">
                                            <button formnovalidate formaction="<?php echo base_url().'complement_karyawan/simpan_barang'?>" style="margin-top:20px" type="submit" class="btn btn-success">TAMBAH MENU MAKANAN</button>
                                        </div>
                                        </div>
                                     ...
                                     <table class="table zero-configuration" style="background-color: gainsboro;">
                                          ...
                                          ?>
                                            <tr>
                                              ...
                                              <td>
                                                <a href="<?php echo base_url();?>complement_karyawan/hapusperbarang/<?php echo $id_menu_makanan;?>/<?php echo $id_complement_karyawan;?>/tambah" class="btn btn-danger">HAPUS</a>
                                              </td>
                                       ...
                                       <div class="col-xl-12 col-md-12 col-12 mb-12">
                                          <button style="float:right;" type="submit" class="btn btn-primary">TAMBAH COMPLEMENT KARYAWAN</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
