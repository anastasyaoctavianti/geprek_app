                ...
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div>
                                      <h4 class="card-title" style="float: left; margin-left: 20px; margin-top: 20px;">LAPORAN COMPLEMENT KARYAWAN</h4>
                  ...
                  <div class="row">
                        ...
                        CABANG
                             ...
                             <form target="_blank" action="<?php echo site_url('complement_karyawan/filter') ?>" method="post">
                   <div class="row">
