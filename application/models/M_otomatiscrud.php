   ...
   <!-- BEGIN: Content-->
    <div class="app-content content">
                ...
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div>
                                      <h4 class="card-title" style="float: left; margin-left: 20px; margin-top: 20px;">'.$nama_asal2.'</h4>
                                     <button style=" float: right!important; margin-bottom: 5px; margin-right: 20px; margin-top: 20px;" type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modaltambah"><i class="fa fa-plus"></i> TAMBAH '.$nama_asal2.'</button>
                                     <a target="_blank" style=" color: white; float: right!important; margin-bottom: 5px; margin-right: 20px; margin-top: 20px;" type="button" class="btn btn-info btn-sm" href="<?php echo base_url();?>'.$nama_asal.'/cetak"><i class="fa fa-print"></i> CETAK</a>
                                ...
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        <div class="table-responsive">
                                            <table class="table zero-configuration '.$tabel_responsive.'">
                                                <thead>
        ...
        '.$string_kolom2.'
                                              ...
                                              <button style="margin: 2px;" type="button"  class="btn btn-danger mdi mdi-pencil btn-sm" data-toggle="modal" data-target="#ModalHapus<?php echo $id_'.$nama_asal.';?>"> DELETE</button>
...
<?php if($this->session->flashdata("berhasil_hapus") == TRUE): ?>
 <script type="text/javascript">
     Swal.fire({
  icon: "success",
  text: "'.$nama_asal3.' Behasil di HAPUS"
})
 </script>
<?php endif; ?>
                ...
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div>
                                      <h4 class="card-title" style="float: left; margin-left: 20px; margin-top: 20px;">LAPORAN '.$nama_asal2.'</h4>
